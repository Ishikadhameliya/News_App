...
import '../../res/components/drawer_component.dart';
import '../../res/helpers/api_helpers.dart';
...
class _homepageState extends State<homepage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Grand News',style: TextStyle(color: Colors.black),),
        centerTitle: true,
                    ...
                    GestureDetector(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          color: (isBusiness) ? Colors.black : Colors.grey.shade300,
                        ),
                        child: Icon(
                  ...
                  children: [
                    GestureDetector(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          shape: BoxShape.circle,
                          color: (isPolitics) ? Colors.black : Colors.grey.shade300,
                        ),
                        child: Icon(
                    ...
                    GestureDetector(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          shape: BoxShape.circle,
                          color:
                          (isTechnology) ? Colors.black : Colors.grey.shade300,
                        ),
                        child: Icon(Icons.military_tech_rounded,
                          size: 27,
                          color:
                          (isTechnology) ? Colors.white : Colors.black,),
                      ),
                    ),
                    const SizedBox(height: 5),
                    const Text(
                  ...
                  children: [
                    GestureDetector(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          shape: BoxShape.circle,
                          color: (isHealth) ? Colors.black : Colors.grey.shade300,
                        ),
                  ...
                  children: [
                    GestureDetector(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          shape: BoxShape.circle,
                          color: (isSport) ? Colors.black : Colors.grey.shade300,
                        ),
                        child: Icon(
                    ...
                    GestureDetector(
                      ...
                      child: Container(
                        ...
                        child: Icon(
                          ...
                          size: 27,
                          color:
                          (isEntertainment) ? Colors.white : Colors.black,
                        ),
                      ),
                    ),
                    const SizedBox(height: 5),
